...
public class Register2Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputPassword = (EditText) findViewById(R.id.editText5pass);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Toast.makeText(getApplicationContext(), "User successfully registered. Step 2(Profile)!", Toast.LENGTH_LONG).show();

                        // Launch Register Profile activity
